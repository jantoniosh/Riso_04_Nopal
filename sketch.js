...
function setup() {
    ...
    riso_filters[2] = new Riso('red');
    riso_filters[3] = new Riso('bubblegum');
    riso_filters[4] = new Riso('yellow');
    riso_filters[5] = new Riso('burgundy');
    riso_filters[6] = new Riso('indigo');
    riso_filters[7] = new Riso('spruce');
    riso_filters[8] = new Riso('maroon');
    riso_filters[0] = new Riso('mint');
    riso_filters[1] = new Riso('coral');
